...
A progressively disclosed density-altitude tool can combine a current trusted real-source
decoded temperature and altimeter setting with a user-entered published field elevation. It uses
the separately documented FAA rule-of-thumb approximation, displays its intermediate pressure
